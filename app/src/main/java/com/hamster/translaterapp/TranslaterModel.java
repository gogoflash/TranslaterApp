...
import com.hamster.translaterapp.data.TranslatesCacheDbHelper;
...
public class TranslaterModel
{
     ...
     * сознательно сэкономил себе время, не заморачиваясь с красивой реализацией.
     **/
    ...
    /**
     * Команда на перевод. Либо найдет в в кеше и вернет из него, либо запросит внешний сервис.
     * */
    ...
    {
        // Сортируем вверх в первую очередь некоторые самые популярные языки:
